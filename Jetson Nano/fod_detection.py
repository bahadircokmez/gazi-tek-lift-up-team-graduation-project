...
net = jetson.inference.detectNet(argv=["--model=/home/gazitek/FOD_detection/model_son/ssd-mobilenet.onnx", 
"--labels=/home/gazitek/FOD_detection/model_son/labels.txt", 
"--input-blob=input_0", 
"--output-cvg=scores", 
"--output-bbox=boxes"])
